...
//In simple javascript we assigned value like this
const Starting = 1;
const Middle = 2;
const Large = 3;
...
enum Intials {
  ...
  Middle,
  Large,
} //by default typescript assign values- 0,1,2....N as length of enums but we can set our on value which can be "number" or "string";
let myIntials: Intials = Intials.Middle;
console.log(myIntials);

//How to optimize our code let see Example
//just use "Const" before enum
const enum Intial {
  Starting = 1,
  Middle,
  Large,
